      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td>
                <a href="handle_student.php?action=approve&id=<?= $row['id']; ?>" onclick="return confirm('Approve this request?')">
                    <i class="bi bi-hand-thumbs-up-fill action-icon approve-icon"></i>
                </a>
                <a href="handle_student.php?action=decline&id=<?= $row['id']; ?>" onclick="return confirm('Decline this request?')">
